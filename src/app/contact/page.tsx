      ...
      <PageHeader maxWidth="max-w-4xl">
        ...
        >
          ...
          <p className="text-zinc-600 dark:text-zinc-400 max-w-lg leading-relaxed mb-6">
            Whether you have a project in mind, a role you think I&apos;d love,
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
            <a
              href={`mailto:${EMAIL}`}
              className="flex items-center justify-center gap-3 bg-sky-600 hover:bg-sky-500 dark:bg-sky-600 dark:hover:bg-sky-500 text-white px-6 sm:px-8 py-4 rounded-xl font-medium transition-colors text-lg shadow-lg shadow-sky-500/25 hover:shadow-sky-500/40 hover:shadow-xl w-full sm:w-auto"
            >
              <Mail size={20} />
              Say Hello
            </a>
            ...
            <button
              onClick={copyEmail}
              className="flex items-center justify-center gap-2.5 bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-600 text-zinc-700 dark:text-zinc-300 px-6 py-4 rounded-xl transition-colors font-mono text-sm w-full sm:w-auto"
            >
              {copied ? (
                <>
